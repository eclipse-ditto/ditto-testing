 ...
 */
package org.eclipse.ditto.testing.common.correlationid;
...
public final class CorrelationId implements CharSequence, Comparable<CorrelationId> {
    ...
    /**
     * Returns a Header with name {@code correlation-id} and this correlation ID's value as value.
     *
     * @return the header.
     */
    public Header toHeader() {
        return new Header("correlation-id", toString());
    }
