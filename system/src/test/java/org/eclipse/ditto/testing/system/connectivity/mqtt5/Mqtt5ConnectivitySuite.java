...
/**
 * Integration tests for Connectivity of MQTT 5 connections.
 * <p>
...
public final class Mqtt5ConnectivitySuite
    ...
    private static final ConnectionType MQTT_TYPE = ConnectionType.MQTT_5;
    ...
    @Override
    protected AbstractConnectivityWorker<BlockingQueue<Mqtt5Publish>, Mqtt5Publish> getConnectivityWorker() {
    ...
    public void setup() {
        ...
        mqttClient =
                Mqtt5Client.builder().serverAddress(new InetSocketAddress(CONFIG.getMqttHostName(),
                        CONFIG.getMqttPortTcp())).identifier(clientId).build().toAsync();
    ...
    public void filterIncomingMqttMessagesByTopicFilters() {
        ...
        final BlockingQueue<Mqtt5Publish> responseConsumer = initResponseConsumer(cf.connectionName1, correlationId);
    ...
    public void allowedHeadersAreMappedToOutboundMqttMessage() throws InterruptedException {
        ...
        final BlockingQueue<Mqtt5Publish> messages = connectivityWorker.subscribe(customTopic, 1);
        final Mqtt5Publish message = messages.poll(5, TimeUnit.SECONDS);
